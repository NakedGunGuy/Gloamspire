            ...
            <flux:rows>
                @foreach($wishlists as $wishlist)
                    ...
                    >
                        ...
                        <flux:cell>{{ $wishlist->edition->set->prefix ?? 'N/A' }}</flux:cell>
                        <flux:cell>{{ $wishlist->edition->collector_number ?? 'N/A' }}</flux:cell>
                        <flux:cell>{{ $wishlist->edition->rarity ?? 'N/A' }}</flux:cell>
                        <flux:cell>{{ $wishlist->user->name ?? 'N/A' }}</flux:cell>
                        <flux:cell>
                            <x-country-flag :country-code="$wishlist->user->country" />
                        </flux:cell>
                        <flux:cell>{{ $wishlist->card_count ?? 'N/A' }}
