            ...
            <flux:rows>
                @foreach($cards as $card)
                    <flux:row :key="$card->id">
                        ...
                        <flux:cell>{{ $card->set->prefix ?? 'N/A' }}</flux:cell>
                        <flux:cell>{{ $card->collector_number ?? 'N/A' }}</flux:cell>
                        <flux:cell><x-card-rarity :rarity="$card->rarity" /></flux:cell>
                        <flux:cell>
                            <flux:dropdown>
